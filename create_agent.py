...
def create_agent(
    ...
    system_prompt = (
        ...
        "If you can't fully complete a task, explain what you've done "
        ...
        "Your other team members (and other teams) will collaborate with "
        "you based on their specialties. "
        "You are chosen for a reason! You are one of the following "
        f"team members: {team_members_str}.\n"
        f"The initial contents of your working directory are:\n"
        f"{initial_directory_contents}\n"
        "Use the ListDirectoryContents tool to check for updates "
        "in the directory contents when needed."
    )
